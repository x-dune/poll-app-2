          ...
          <div className="nav-wrapper deep-purple">
            <Link href="/">
              <a className="brand-logo">
                <i className="material-icons" style={{ fontSize: "3.5rem" }}>
                  poll
                </i>
            ...
            <ul className="right hide-on-med-and-down mr-3">
              <li>
                <Link href="/new">
                  <a className="btn yellow black-text waves-effect waves-light">
                    Create New Poll
                  </a>
                </Link>
              </li>
              ...
              <li>
                <a
                  ...
                  onClick={() => this.handleSearch("search-med")}
                >
            ...
            <div className="row mb-0">
              ...
              <div className="col s2 px-0">
                <button
                  ...
                  onClick={() => this.handleSearch("search-small")}
                >
                  <i className="material-icons center">search</i>
                </button>
              </div>
          ...
          <li>
            <Link href="/new">
              <a className="sidenav-close">
                <i className="material-icons left ml-0 mr-1">add</i> Create New
                Poll
              </a>
            </Link>
          </li>
