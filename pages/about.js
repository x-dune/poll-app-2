        ...
        <Layout>
            <div className="card mt-5">
                <div className="card-content">
                    <span className="card-title center-align">About This Application</span>
                    <blockquote className="py-1"><h6>Coded with &#10084;&#65039; & &#9749; by Adam Ho</h6></blockquote>
                    <ul>
                        {
                            [
                                <p>
                            ...
                            <p>
                                <Link href="https://mongoosejs.com/"><a>Mongoose.js</a></Link> was used as an Object Document Mapper for MongoDB.
                            </p>,
                                <p>
                                    Styled using the <Link href="https://materializecss.com/"><a>Materialize</a></Link> HTML/CSS framework and <Link href="https://getbootstrap.com/"><a>Bootstrap</a></Link> utility classes.
                            </p>,
                                <p>
                                    Donut chart was made using <Link href="https://www.chartjs.org/"><a>Chart.js</a></Link>.
                            </p>
